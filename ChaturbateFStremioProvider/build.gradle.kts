...
cloudstream {
    language = "en"
    description = "Live Chaturbate Girls cams (Stremio bridge). Bridges the Chaturbate Stremio addon (chaturbate.stremio.homes/f) - Popular + region + Couples Live rows, genre rows, live search, full room metadata and direct LL-HLS stream links."

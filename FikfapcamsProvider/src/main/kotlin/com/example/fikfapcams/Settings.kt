...
/**
 * Per-provider in-app settings for FikFapCams: proxy URL and enabled home
...
object Settings {
    ...
    private const val KEY_PROXY = "fikfapcams_proxy"
    private const val KEY_ROWS = "fikfapcams_rows"
    ...
    private fun ctx(): Context? = FikfapcamsProviderPlugin.appContext

...
/**
 * Per-provider in-app settings for Sinparty: optional proxy prefix. Persisted in
 * SharedPreferences so it survives restarts.
 */
object Settings {
    private const val PREFS = "TotalGirls_settings"

    private const val KEY_PROXY = "sinparty_proxy"

    const val DEFAULT_PROXY = ""

    private fun ctx(): Context? = SinpartyProviderPlugin.appContext

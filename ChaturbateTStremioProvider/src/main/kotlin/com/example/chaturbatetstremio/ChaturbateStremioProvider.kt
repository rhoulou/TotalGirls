package com.example.chaturbatetstremio
...
/**
 * CloudStream 3 provider for Chaturbate live cams - Trans (Stremio addon bridge).
 *
...
class ChaturbateStremioProvider : MainAPI() {
    ...
    override var name = "Chaturbate Trans Stremio"
    override val supportedTypes = setOf(TvType.Live)
    override val hasMainPage = true
    override val hasQuickSearch = true

    private val fmt: String = "t"

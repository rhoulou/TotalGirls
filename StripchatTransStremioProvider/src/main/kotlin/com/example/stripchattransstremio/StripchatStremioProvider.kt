package com.example.stripchattransstremio
...
/**
 * CloudStream 3 provider for Stripchat live cams - Trans (Stremio addon bridge).
 *
...
class StripchatStremioProvider : MainAPI() {
    ...
    override var name = "Stripchat Trans Stremio"
    override val supportedTypes = setOf(TvType.Live)
    override val hasMainPage = true
    override val hasQuickSearch = true

    private val seg: String = "trans"

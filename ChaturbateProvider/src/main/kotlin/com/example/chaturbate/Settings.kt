...
/**
 * Per-provider in-app settings for Chaturbate: proxy URL, enabled genders and
...
object Settings {
    ...
    private const val KEY_PROXY = "chaturbate_proxy"
    private const val KEY_GENDERS = "chaturbate_genders"
    private const val KEY_ROWS = "chaturbate_rows"
    ...
    /** Full genre row set (union of the women/men/trans genre lists). */
    val ALL_ROWS = listOf(
        "Teen", "Young", "MILF", "Mature", "Bigboobs", "Bigass", "Hairy", "Latina",
        "BBW", "Squirt", "Skinny", "Smalltits", "Feet", "Fuckmachine", "DILF", "Bigcook",
        "Cum", "Lovense", "Muscle", "Latino", "New", "ILF", "Smallcook", "Mistress",
        "Femboy", "Partyhouse"
    )

    private fun ctx(): Context? = ChaturbateProviderPlugin.appContext
    ...
    /** Enabled genre row names (default: all rows). */
    fun rows(): Set<String> {
